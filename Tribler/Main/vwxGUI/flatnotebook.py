...
class TabNavigatorWindow(wx.Dialog):
    ...
    def __init__(self, parent=None, icon=None):
        ...
        font = wx.SystemSettings_GetFont(wx.SYS_DEFAULT_GUI_FONT) if not parent else self.parent.GetFont()
    ...
    def OnPanelPaint(self, event):
        ...
        font = wx.SystemSettings_GetFont(wx.SYS_DEFAULT_GUI_FONT) if not self.GetParent() else self.GetParent().GetFont()
        font.SetWeight(wx.BOLD)
        mem_dc.SetFont(font)
...
class FNBRenderer(object):
    ...
    def CalcTabWidth(self, pageContainer, tabIdx, tabHeight):
        ...
        boldFont = wx.SystemSettings_GetFont(wx.SYS_DEFAULT_GUI_FONT) if not pc.GetParent() else pc.GetParent().GetFont()
    ...
    def CalcTabHeight(self, pageContainer):
        ...
        normalFont = wx.SystemSettings_GetFont(wx.SYS_DEFAULT_GUI_FONT) if not pc.GetParent() else pc.GetParent().GetFont()
        boldFont = normalFont
...
class FNBRendererRibbonTabs(FNBRenderer):
    ...
    def CalcTabWidth(self, pageContainer, tabIdx, tabHeight):
        ...
        font = wx.SystemSettings_GetFont(wx.SYS_DEFAULT_GUI_FONT) if not pc.GetParent() else pc.GetParent().GetFont()
...
class FlatNotebook(wx.PyPanel):
    ...
    def Init(self):
        ...
        if "__WXGTK__" in wx.PlatformInfo:
            ...
            # for the tabs will get the proper height on initialization
            # on MSW, preforming these steps yields wierd results
            boldFont = wx.SystemSettings_GetFont(wx.SYS_DEFAULT_GUI_FONT) if not self.GetParent() else self.GetParent().GetFont()
            boldFont.SetWeight(wx.FONTWEIGHT_BOLD)
            dc.SetFont(boldFont)
...
class PageContainer(wx.Panel):
    ...
    def __init__(self, parent, id=wx.ID_ANY, pos=wx.DefaultPosition,
        ...
        if "__WXGTK__" in wx.PlatformInfo:
            boldFont = wx.SystemSettings_GetFont(wx.SYS_DEFAULT_GUI_FONT) if not parent else parent.GetFont()
