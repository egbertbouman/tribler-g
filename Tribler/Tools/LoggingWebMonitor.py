...
class LoggingReceiver(SocketServer.ThreadingTCPServer):
    ...
    def __init__(self, host='10.0.0.10',
                 port=None,
...
<html>
  <head>
    ...
    <title>GameCast Logging Server Status Page</title>
    <link rel="stylesheet" type="text/css" href="/default.css">
  </head>
  <body>
    <table class="vtable">
      <caption>GameCast Logging Server Status Page</caption>
      <tr>
    ...
    <table class="htable" style="margin-top:0;">
      <tr class="heading"><th>Timestamp</th><th>Event</th><th>At peer</th><th>To/from peer</th><th>Details</th></tr>
      %(records)s
    </table>
...
def main():
    ...
    formatter = logging.Formatter('%(created).3f   %(event_type)-8s   %(at_peer_short)s   %(tf_peer_short)-34s   %(message)s')
