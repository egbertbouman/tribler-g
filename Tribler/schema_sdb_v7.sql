...
CREATE TABLE Peer (
  ...
  -- Patch for GameCast (gc_*)
  gc_member            integer DEFAULT 0,
  gc_last_seen         numeric DEFAULT 0,
  gc_last_recieved     numeric DEFAULT 0
);
...
lastmove_time float DEFAULT 0,
finished_time float DEFAULT 0,
