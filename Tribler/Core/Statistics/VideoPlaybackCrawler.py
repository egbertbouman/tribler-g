...
# 24/06/11 boudewijn: this crawler uses cPickle for communication from the client to the crawler,
# since we are not using the video playback statistics at all, we choose to disable the entire
# crawler.
