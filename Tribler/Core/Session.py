...
class Session(SessionRuntimeConfig):
    ...
    def __init__(self,scfg=None,ignore_singleton=False):
        ...
        # 4. superpeer.txt, gc_superpeer.txt and crawler.txt
        ...
        if self.sessconfig['gc_superpeer_file'] is None:
            self.sessconfig['gc_superpeer_file'] = os.path.join(self.sessconfig['install_dir'],LIBRARYNAME,'Core','gc_superpeer.txt')
    ...
    def open_dbhandler(self,subject):
        ...
        try:
            ...
            elif subject == NTFY_GAMECAST:
                return self.lm.gamecast_db
            else:
