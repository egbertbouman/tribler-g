...
class Decoder:
    ...
    def __init__(self):
        ...
        # GuestLZMX offers you a draw.
        self.drawPattern = re.compile('^(\S+) offers you a draw.*$')

        # GuestLZMX would like to abort the game; type "abort" to accept.
        self.abortPattern = re.compile('^(\S+) would like to abort the game.*$')
        ...
        self.patterns = [self.announcePattern, self.nameAssignPattern,
                         ...
                         self.seekPattern, self.endSeekPattern, self.drawPattern, self.abortPattern]
    ...
    def parseLine(self, line):
        ...
        for pattern in self.patterns:
            ...
            if len(result) != 0:
                ...
                elif pattern is self.drawPattern:
                    name = result
                    return (self.onDrawRequest, (name, ))

                elif pattern is self.abortPattern:
                    name = result
                    return (self.onAbortRequest, (name, ))
