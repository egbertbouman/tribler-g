...
GameCastGossipMessages = [GC_GOSSIP, GC_ALIVE]
GameCastMessages = [GC_CMD]

# All overlay-swarm messages
OverlaySwarmMessages = PermIDMessages + BuddyCastMessages + MetadataMessages + DoeMessages + ProxyMessages + SocialNetworkMessages + RemoteQueryMessages + CrawlerMessages + GameCastGossipMessages + GameCastMessages
