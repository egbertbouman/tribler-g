...
class SessionConfigInterface:
    ...
    # Gamecast
    #
    def set_gamecast(self,value):
        """ Enable the gamecast system at startup (default = True)
        @param value Boolean.
        """
        self.sessconfig['gamecast'] = value

    def get_gamecast(self):
        """ Returns whether gamecast is enabled at startup.
        @return Boolean."""
        return self.sessconfig['gamecast']
    ...
    def set_gc_superpeer_file(self,value):
        """ File with addresses of GameCast superpeers (default = install_dir+
        Tribler/Core/gc_superpeer.txt).
        @param value An absolute path name.
        """
        self.sessconfig['gc_superpeer_file'] = value

    def get_gc_superpeer_file(self):
        """ Returns the GameCast superpeer file.
        @return An absolute path name. """
        return self.sessconfig['gc_superpeer_file']
