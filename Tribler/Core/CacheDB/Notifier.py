...
class Notifier:
    ...
    SUBJECTS = [NTFY_PEERS, NTFY_TORRENTS, NTFY_PREFERENCES, NTFY_MYPREFERENCES, NTFY_ACTIVITIES, NTFY_REACHABLE, NTFY_CHANNELCAST, NTFY_VOTECAST, NTFY_RICH_METADATA, NTFY_SUBTITLE_CONTENTS, NTFY_PROXYDOWNLOADER, NTFY_PROXYDISCOVERY, NTFY_GUI_STARTED, NTFY_DISPERSY, NTFY_GAMECAST]
